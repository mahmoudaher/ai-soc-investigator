...
export const caseInfoContent: InfobarContent = {
  title: 'Investigation Cases',
  sections: [
    {
      title: 'Backend endpoints',
      description:
        'The cases page reads from FastAPI GET /cases, opens details with GET /cases/{case_id}, and shows workflow history from GET /cases/{case_id}/checkpoints.',
      links: []
    },
    {
      title: 'Presenting a case',
      description:
        'Use Present Case to POST a raw Wazuh alert to /alerts/wazuh. The backend normalizes the alert into a CaseFile and can launch the investigation workflow in the background.',
      links: []
    },
    {
      title: 'Case file fields',
      description:
        'Each case includes status, severity, category, entities, evidence, timeline events, MITRE techniques, recommendations, agent runs, and the original normalized alert.',
      links: []
    }
  ]
};
