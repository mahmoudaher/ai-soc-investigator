...
const defaultData = {
  title: 'AI SOC Investigator',
  sections: [
    {
      title: 'Case Workflow',
      description:
        'Use the dashboard to ingest Wazuh alerts, review persisted case files, inspect agent checkpoints, and present investigation results.',
      links: [
        {
          title: 'Cases',
          url: '/dashboard/cases'
